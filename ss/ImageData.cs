    ...
    abstract public class ImageData {
       ...
       */
        override public string ToString ( ) {
            return "{ \n"
                + "    \"mMax\": "              + mMax + ", \n"   //good enough for max image pixel value 
                + "    \"mDisplayData\": "      + "[...], \n"            //good enough for arrays
                + "    \"mDisplayImage\": "     + mDisplayImage + ", \n"  //good enough other contained objects
                + "    \"mIsColor\": "          + mIsColor + ", \n"      // good enough for color value 
                + "    \"mIsAudio\": "          + mIsAudio + ", \n"         //good enough for audio value 
                + "    \"mImageModified\": "    + mImageModified + ", \n"   //good enough for image modified data
                + "    \"mW\": "                + mW + ", \n"                  // good enough for image width data
                + "    \"mH\": "                + mH + ", \n"                   // good enough for height width data
                + "    \"mMin\": "              + mMin + ", \n"                 // good  enough for min image pixel value Data
                + "    \"mRate\": "             + mRate + ", \n"                //  good enough for sample per sec(audio only)
                + "    \"mFname\": "            + mFname + ", \n"               // good enough for File Name Data
                + "    \"mOriginalData\": "     + "[...] \n"                    // good enough for contained Objects.
                + "}";
        }
        //----------------------------------------------------------------
